...
public class ImplementationGuideByNameR4OperationProvider {
	...
	public ImplementationGuideByNameR4OperationProvider(final IPackageInstallerSvc packageInstallerSvc) {
		this.packageInstallerSvc = packageInstallerSvc;
	}

	@Operation(name = "$installByName", typeName = "ImplementationGuide")
	public Parameters installByName(@OperationParam(name = "name", min = 1, max = 1) final String name, @OperationParam(name = "version", min = 1, max = 1) final String version, @OperationParam(name = "url", min = 1, max = 1) final String url) {
